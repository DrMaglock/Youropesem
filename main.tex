...
\include{./Interviews/runce} %check whether this is the correct place
\include{./Interviews/lensky}%check the dates
...
\nocite{*}
\printbibliography %sum ifnum thing going on because of apa style
\end{document}
